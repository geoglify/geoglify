...
const applyFilter = (newFilters: Partial<TableFilters> = {}) => {
  const filters = {
    search: search.value,
  ...
  router.get(route(props.routeName), filters, {
    preserveState: true,
    replace: true,
  });
};
      ...
      <div class="flex items-center justify-end space-x-2">
        ...
        <div class="space-x-2">
          <Button 
            ...
            @click="router.get(data.prev_page_url)"
          >
            Previous
          </Button>
          <Button 
            ...
            @click="router.get(data.next_page_url)"
          >
            Next
          </Button>
        </div>
