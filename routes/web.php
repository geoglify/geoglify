...
Route::prefix('realtime/ships')->middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('top-types', [ShipController::class, 'topShipTypes']); // Get top ship types
    Route::get('countries', [ShipController::class, 'countCountries']); // Get ship count per country
